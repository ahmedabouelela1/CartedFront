...
import 'add_bottom_model.dart';
export 'add_bottom_model.dart';

class AddBottomWidget extends StatefulWidget {
  const AddBottomWidget({Key? key}) : super(key: key);

  @override
  _AddBottomWidgetState createState() => _AddBottomWidgetState();
}

class _AddBottomWidgetState extends State<AddBottomWidget>
    with TickerProviderStateMixin {
  late AddBottomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddBottomModel());
    ...
    _model.apartmentController ??= TextEditingController();
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      width: double.infinity,
                                      child: TextFormField(
                                        controller: _model.apartmentController,
                        ...
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.addAddress = await AddAddressCall.call(
                                fullAddress: _model.fullAddressController.text,
                                building: _model.buildingController.text,
                                authToken: FFAppState().Token,
                                apartment: _model.apartmentController.text,
