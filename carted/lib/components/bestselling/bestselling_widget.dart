...
import 'bestselling_model.dart';
export 'bestselling_model.dart';
...
class _BestsellingWidgetState extends State<BestsellingWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BestsellingModel());
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  'All products are our best sellers ;)',
