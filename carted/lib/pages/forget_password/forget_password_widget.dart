                    ...
                    children: [
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            18.0, 0.0, 18.0, 15.0),
                        child: Text(
                          'Enter the email address associated with your Carted account, and we\'ll send you a reset token',
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            _model.forgotPass =
                                await NoAuthGroup.forgotPasswordCall.call(
                              email: _model.emailController.text,
                            );
                            if ((_model.forgotPass?.statusCode ?? 200) == 200) {
                              setState(() {
                                FFAppState().ResetToken = true;
                              });
                            ...
                            } else if ((_model.forgotPass?.statusCode ?? 200) ==
                                204) {
                              ScaffoldMessenger.of(context).clearSnackBars();
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              _model.checkToken =
                                                ...
                                                token:
                                                    _model.tokenController.text,
                                              );
                                              if ((_model
                                                      .checkToken?.succeeded ??
                                                  true)) {
                                                context.pushNamed(
                                                  'PassReset',
                                                  queryParameters: {
