...
class SignUpModel extends FlutterFlowModel<SignUpWidget> {
  ...
  // State field(s) for Pconf widget.
  FocusNode? pconfFocusNode;
  TextEditingController? pconfController;
  late bool pconfVisibility;
  String? Function(BuildContext, String?)? pconfControllerValidator;
  String? _pconfControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Field is required';
    }
  ...
  void initState(BuildContext context) {
    ...
    pconfVisibility = false;
    pconfControllerValidator = _pconfControllerValidator;
  }
