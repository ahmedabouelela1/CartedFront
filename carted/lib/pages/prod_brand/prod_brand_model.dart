...
import 'prod_brand_widget.dart' show ProdBrandWidget;
...
class ProdBrandModel extends FlutterFlowModel<ProdBrandWidget> {
  ...
  PagingController<ApiPagingParams, dynamic> _createGridViewController(
    ...
    return controller..addPageRequestListener(gridViewProdBrandPage);
  }

  void gridViewProdBrandPage(ApiPagingParams nextPageMarker) =>
      gridViewApiCall!(nextPageMarker).then((gridViewProdBrandResponse) {
        final pageItems = (NoAuthGroup.prodBrandCall.products(
                  gridViewProdBrandResponse.jsonBody,
                )! ??
                [])
            .toList() as List;
        ...
        gridViewPagingController?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse: gridViewProdBrandResponse,
                )
              : null,
        );
      });
