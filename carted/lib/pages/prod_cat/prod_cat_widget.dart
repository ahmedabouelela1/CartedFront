...
import 'prod_cat_model.dart';
export 'prod_cat_model.dart';

class ProdCatWidget extends StatefulWidget {
  const ProdCatWidget({
    Key? key,
    required this.catId,
    required this.sex,
  ...
  @override
  _ProdCatWidgetState createState() => _ProdCatWidgetState();
}

class _ProdCatWidgetState extends State<ProdCatWidget> {
  late ProdCatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProdCatModel());
                  ...
                  Expanded(
                    child: Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(
                          12.0, 12.0, 12.0, 12.0),
                      child: FutureBuilder<ApiCallResponse>(
                        future: NoAuthGroup.prodCatCall.call(
                          catId: widget.catId,
                          sex: widget.sex,
                        ...
                        builder: (context, snapshot) {
                          ...
                          final gridViewProdCatResponse = snapshot.data!;
                          return Builder(
                            builder: (context) {
                              final eachProd = NoAuthGroup.prodCatCall
                                      .product(
                                        gridViewProdCatResponse.jsonBody,
                                      )
                                      ?.toList() ??
                                  [];
                              if (eachProd.isEmpty) {
                              ...
                              return GridView.builder(
                                ...
                                itemBuilder: (context, eachProdIndex) {
                                  final eachProdItem = eachProd[eachProdIndex];
                                  return InkWell(
                                    splashColor: Colors.transparent,
                                    focusColor: Colors.transparent,
                                    hoverColor: Colors.transparent,
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    child: FavIconWidget(
                                                      key: Key(
                                                          'Key7hd_${eachProdIndex}_of_${eachProd.length}'),
